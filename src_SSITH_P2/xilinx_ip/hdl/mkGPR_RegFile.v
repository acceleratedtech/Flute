...
//
// On Mon Feb 10 22:33:04 EST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkGPR_RegFile(CLK,
  ...
  output [97 : 0] read_rs1;

  // value method read_rs1_port2
  input  [4 : 0] read_rs1_port2_rs1;
  output [97 : 0] read_rs1_port2;

  // value method read_rs2
  input  [4 : 0] read_rs2_rs2;
  output [97 : 0] read_rs2;

  // action method write_rd
  input  [4 : 0] write_rd_rd;
  input  [97 : 0] write_rd_rd_val;
  input  EN_write_rd;

  // signals for module outputs
  wire [97 : 0] read_rs1, read_rs1_port2, read_rs2;
  ...
  assign regfile$D_IN = MUX_regfile$upd_1__SEL_1 ? write_rd_rd_val : 98'd0 ;
  assign regfile$WE =
